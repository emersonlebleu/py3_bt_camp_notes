#-----Instuctions-----#
# Create a file called `scraping_project.py` which, when run, grabs data on every quote from 
...
# If the player gets to zero guesses without identifying the author, 
# the player loses and the game ends. If the player correctly identifies the author, 
# the player wins!
...
# Some ideas: the first letter of the author's first name, 
